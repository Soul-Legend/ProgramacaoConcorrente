...
// A possibilidade de um impasse foi evitada através da reordenação do
// decremento do semáforo e do bloqueio do mutex, de modo que o semáforo seja
// sempre decrementado antes que o mutex seja bloqueado em todas as threads.
